...
class AlipayService
{
     ...
     * @return self
     */
    static public function getInstance($type = 'web')
    {
        if (!static::$instance || static::$type != $type) {
            static::$instance = new static(
                config('alipay.' . $type . '.app_id'),
                config('alipay.' . $type . '.alipay_public_key_path'),
                config('alipay.' . $type . '.app_private_key_path')
            );
        }
